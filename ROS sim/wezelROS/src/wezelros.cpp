...
void odRos(const wezelROS::ros2s& msg);
void odSerwo(const dynamixel_servos::InfoMessage& msg);
void przygotujWiadomoscDoRos(wezelROS::s2ros& msg);
...
ros::Publisher rosPub = n3.advertise<wezelROS::s2ros>("t_w2ros", 1000);
